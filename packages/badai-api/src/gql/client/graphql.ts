...
export type MutationAuthBlumMetamaskLoginArgs = {
...
export type PageWithSimilarity = {
  __typename?: 'PageWithSimilarity';
...
export type PagesWithSimilarityByDocument = {
  __typename?: 'PagesWithSimilarityByDocument';
  ...
  pages: Array<PageWithSimilarity>;
};
...
export type Query = {
   ...
   */
  kdbSemanticSearchPagesByChunkEmbeddings: Array<PagesWithSimilarityByDocument>;
...
export type QueryAuthBlumMetamaskMessageArgs = {
  address: Scalars['MetamaskAddress']['input'];
  input: TelegramSecureLoginInput;
};
...
export type QueryKdbSemanticSearchPagesByChunkEmbeddingsArgs = {
  collections: Array<Scalars['CollectionID']['input']>;
  filters?: SemanticSearchPagesByChunkEmbeddingsFilters;
  options?: SemanticSearchPagesByChunkEmbeddingsOptions;
...
export type SemanticSearchPagesByChunkEmbeddingsDocumentPublishedRange = {
  /**
...
export type SemanticSearchPagesByChunkEmbeddingsFilters = {
  /**
   ...
   */
  document_ids?: InputMaybe<Array<Scalars['DocumentID']['input']>>;
  /**
   ...
   */
  document_published_range?: InputMaybe<SemanticSearchPagesByChunkEmbeddingsDocumentPublishedRange>;
};

/** Options for configuring the semantic search of pages by chunk embeddings. */
export type SemanticSearchPagesByChunkEmbeddingsOptions = {
  /** The maximum number of pages to return in the search results. */
  pages_count?: Scalars['Int']['input'];
  /**
   ...
   */
  similarity_threshold?: Scalars['Float']['input'];
  /**
...
export type TelegramSecureLoginInput = {
  sign: Scalars['String']['input'];
...
export type AuthBlumMetamaskMessageQueryVariables = Exact<{
  address: Scalars['MetamaskAddress']['input'];
  input: TelegramSecureLoginInput;
}>;


export type AuthBlumMetamaskMessageQuery = { __typename?: 'Query', authBlumMetamaskMessage: any };
...
export type KdbGetPagesByDocumentQueryVariables = Exact<{
  session: Scalars['Session']['input'];
  document_id: Scalars['DocumentID']['input'];
  filters?: InputMaybe<GetPagesByDocumentFilters>;
}>;


export type KdbGetPagesByDocumentQuery = { __typename?: 'Query', kdbGetPagesByDocument: Array<{ __typename?: 'Page', page_id: any, content: string, description?: string | null, document_id: any, task_id: any, number: number }> };
...
export type KdbIndexingDocumentTaskGetByCollectionQuery = { __typename?: 'Query', kdbIndexingDocumentTaskGetByCollection: Array<(
    { __typename?: 'IndexingDocumentTask' }
    & { ' $fragmentRefs'?: { 'IndexingDocumentTaskFieldsFragment': IndexingDocumentTaskFieldsFragment } }
  )> };
...
export type KdbCreateCollectionMutationVariables = Exact<{
  session: Scalars['Session']['input'];
  input: CreateAgentCollectionInput;
}>;


export type KdbCreateCollectionMutation = { __typename?: 'Mutation', kdbCreateAgentCollection: { __typename?: 'Collection', collection_id: any } };
...
export type KdbCreatePageMutation = { __typename?: 'Mutation', kdbCreatePage: Array<{ __typename?: 'Page', page_id: any, content: string, description?: string | null, document_id: any, task_id: any, number: number, indexing_state: { __typename?: 'IndexingState', completion_cost: number, completion_tokens: number, content_tokens: number, embedding_cost: number, is_embedded: boolean, is_indexed_qa: boolean, is_indexed_triplet: boolean, is_parsed: boolean, is_summarized: boolean, prompt_cost: number, prompt_tokens: number } }> };
...
export type MarketplaceAgentQuery = { __typename?: 'Query', marketplaceAgent: { __typename?: 'AgentMeta', agent_id: any, username: any, first_name: string, last_name?: string | null, avatar: string, role: string, can_answer: boolean, owner_id: any, chain_graph_id: any, template_params: any, purpose: string, prompt: string, self_awareness: string, llm_model: string, llm_config: { __typename?: 'LLMConfig', model: string, max_tokens: number, temperature: number }, tools: Array<{ __typename?: 'Tool', name: string }>, chat_history_config: { __typename?: 'ChatHistoryConfig', messages_count: number, tokens_limit: number } } };
...
export type AuthBlumMetamaskLoginMutationVariables = Exact<{
  session: Scalars['Session']['input'];
  input: MetamaskLoginInput;
}>;


export type AuthBlumMetamaskLoginMutation = { __typename?: 'Mutation', authBlumMetamaskLogin: { __typename?: 'LoginResult', session: any, user_profile: { __typename?: 'UserProfile', id: any, name: string, picture: string, meta?: any | null } } };
...
export type ReadSecretQuery = { __typename?: 'Query', secret: { __typename?: 'SecretResponse', hkdfNonce: string, publicKey: string, secret: { __typename?: 'Secret', encrypted: string, metadata: { __typename?: 'SecretMetadata', type: string } } } };
...
export const AuthBlumMetamaskMessageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AuthBlumMetamaskMessage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"address"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"MetamaskAddress"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"TelegramSecureLoginInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"authBlumMetamaskMessage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"address"},"value":{"kind":"Variable","name":{"kind":"Name","value":"address"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<AuthBlumMetamaskMessageQuery, AuthBlumMetamaskMessageQueryVariables>;
...
export const KdbIndexingDocumentTaskGetByCollectionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"kdbIndexingDocumentTaskGetByCollection"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"session"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Session"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"collections"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CollectionID"}}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"states"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"IndexingDocumentTaskState"}}}},"defaultValue":{"kind":"ListValue","values":[]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"kdbIndexingDocumentTaskGetByCollection"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"session"},"value":{"kind":"Variable","name":{"kind":"Name","value":"session"}}},{"kind":"Argument","name":{"kind":"Name","value":"collection_id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"collections"}}},{"kind":"Argument","name":{"kind":"Name","value":"state"},"value":{"kind":"Variable","name":{"kind":"Name","value":"states"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"IndexingDocumentTaskFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"IndexingDocumentTaskFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"IndexingDocumentTask"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"task_id"}},{"kind":"Field","name":{"kind":"Name","value":"document_id"}},{"kind":"Field","name":{"kind":"Name","value":"chat_id"}},{"kind":"Field","name":{"kind":"Name","value":"message_id"}},{"kind":"Field","name":{"kind":"Name","value":"author_id"}},{"kind":"Field","name":{"kind":"Name","value":"task_state"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"update_at"}},{"kind":"Field","name":{"kind":"Name","value":"confirmed"}},{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"error"}},{"kind":"Field","name":{"kind":"Name","value":"statistics"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"chunks_indexed_qa"}},{"kind":"Field","name":{"kind":"Name","value":"chunks_indexed_triplet"}},{"kind":"Field","name":{"kind":"Name","value":"chunks_total"}},{"kind":"Field","name":{"kind":"Name","value":"current_indexing_speed"}},{"kind":"Field","name":{"kind":"Name","value":"expected_finish_seconds"}},{"kind":"Field","name":{"kind":"Name","value":"expected_finished_at"}},{"kind":"Field","name":{"kind":"Name","value":"indexed_percent"}},{"kind":"Field","name":{"kind":"Name","value":"indexing_started_at"}},{"kind":"Field","name":{"kind":"Name","value":"llm_approximate_cost"}},{"kind":"Field","name":{"kind":"Name","value":"llm_stats"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"completion_cost"}},{"kind":"Field","name":{"kind":"Name","value":"embeddings_cost"}},{"kind":"Field","name":{"kind":"Name","value":"embeddings_count"}},{"kind":"Field","name":{"kind":"Name","value":"prompt_cost"}},{"kind":"Field","name":{"kind":"Name","value":"total_cost"}}]}},{"kind":"Field","name":{"kind":"Name","value":"pages"}},{"kind":"Field","name":{"kind":"Name","value":"qa_total"}},{"kind":"Field","name":{"kind":"Name","value":"total_tokens"}},{"kind":"Field","name":{"kind":"Name","value":"triplets_total"}},{"kind":"Field","name":{"kind":"Name","value":"indexed_for_seconds"}}]}},{"kind":"Field","name":{"kind":"Name","value":"config"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"chunk_overlap_tokens"}},{"kind":"Field","name":{"kind":"Name","value":"chunk_size_tokens"}},{"kind":"Field","name":{"kind":"Name","value":"cost_limit"}},{"kind":"Field","name":{"kind":"Name","value":"need_qa"}},{"kind":"Field","name":{"kind":"Name","value":"qa_count_per_run"}},{"kind":"Field","name":{"kind":"Name","value":"qa_model"}},{"kind":"Field","name":{"kind":"Name","value":"force_confirm"}},{"kind":"Field","name":{"kind":"Name","value":"instruction_for_qa"}}]}}]}}]} as unknown as DocumentNode<KdbIndexingDocumentTaskGetByCollectionQuery, KdbIndexingDocumentTaskGetByCollectionQueryVariables>;
export const KdbIndexingDocumentTaskGetByDocumentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"kdbIndexingDocumentTaskGetByDocument"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"session"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Session"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"document_id"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DocumentID"}}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"state"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"IndexingDocumentTaskState"}}}},"defaultValue":{"kind":"ListValue","values":[]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"kdbIndexingDocumentTaskGetByDocument"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"session"},"value":{"kind":"Variable","name":{"kind":"Name","value":"session"}}},{"kind":"Argument","name":{"kind":"Name","value":"document_id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"document_id"}}},{"kind":"Argument","name":{"kind":"Name","value":"state"},"value":{"kind":"Variable","name":{"kind":"Name","value":"state"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"IndexingDocumentTaskFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"IndexingDocumentTaskFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"IndexingDocumentTask"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"task_id"}},{"kind":"Field","name":{"kind":"Name","value":"document_id"}},{"kind":"Field","name":{"kind":"Name","value":"chat_id"}},{"kind":"Field","name":{"kind":"Name","value":"message_id"}},{"kind":"Field","name":{"kind":"Name","value":"author_id"}},{"kind":"Field","name":{"kind":"Name","value":"task_state"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"update_at"}},{"kind":"Field","name":{"kind":"Name","value":"confirmed"}},{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"error"}},{"kind":"Field","name":{"kind":"Name","value":"statistics"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"chunks_indexed_qa"}},{"kind":"Field","name":{"kind":"Name","value":"chunks_indexed_triplet"}},{"kind":"Field","name":{"kind":"Name","value":"chunks_total"}},{"kind":"Field","name":{"kind":"Name","value":"current_indexing_speed"}},{"kind":"Field","name":{"kind":"Name","value":"expected_finish_seconds"}},{"kind":"Field","name":{"kind":"Name","value":"expected_finished_at"}},{"kind":"Field","name":{"kind":"Name","value":"indexed_percent"}},{"kind":"Field","name":{"kind":"Name","value":"indexing_started_at"}},{"kind":"Field","name":{"kind":"Name","value":"llm_approximate_cost"}},{"kind":"Field","name":{"kind":"Name","value":"llm_stats"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"completion_cost"}},{"kind":"Field","name":{"kind":"Name","value":"embeddings_cost"}},{"kind":"Field","name":{"kind":"Name","value":"embeddings_count"}},{"kind":"Field","name":{"kind":"Name","value":"prompt_cost"}},{"kind":"Field","name":{"kind":"Name","value":"total_cost"}}]}},{"kind":"Field","name":{"kind":"Name","value":"pages"}},{"kind":"Field","name":{"kind":"Name","value":"qa_total"}},{"kind":"Field","name":{"kind":"Name","value":"total_tokens"}},{"kind":"Field","name":{"kind":"Name","value":"triplets_total"}},{"kind":"Field","name":{"kind":"Name","value":"indexed_for_seconds"}}]}},{"kind":"Field","name":{"kind":"Name","value":"config"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"chunk_overlap_tokens"}},{"kind":"Field","name":{"kind":"Name","value":"chunk_size_tokens"}},{"kind":"Field","name":{"kind":"Name","value":"cost_limit"}},{"kind":"Field","name":{"kind":"Name","value":"need_qa"}},{"kind":"Field","name":{"kind":"Name","value":"qa_count_per_run"}},{"kind":"Field","name":{"kind":"Name","value":"qa_model"}},{"kind":"Field","name":{"kind":"Name","value":"force_confirm"}},{"kind":"Field","name":{"kind":"Name","value":"instruction_for_qa"}}]}}]}}]} as unknown as DocumentNode<KdbIndexingDocumentTaskGetByDocumentQuery, KdbIndexingDocumentTaskGetByDocumentQueryVariables>;
...
export const KdbCreateCollectionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"KDBCreateCollection"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"session"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Session"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateAgentCollectionInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"kdbCreateAgentCollection"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"session"},"value":{"kind":"Variable","name":{"kind":"Name","value":"session"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"collection_id"}}]}}]}}]} as unknown as DocumentNode<KdbCreateCollectionMutation, KdbCreateCollectionMutationVariables>;
...
export const AuthBlumMetamaskLoginDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AuthBlumMetamaskLogin"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"session"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Session"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"MetamaskLoginInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"authBlumMetamaskLogin"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"session"},"value":{"kind":"Variable","name":{"kind":"Name","value":"session"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"session"}},{"kind":"Field","name":{"kind":"Name","value":"user_profile"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"picture"}},{"kind":"Field","name":{"kind":"Name","value":"meta"}}]}}]}}]}}]} as unknown as DocumentNode<AuthBlumMetamaskLoginMutation, AuthBlumMetamaskLoginMutationVariables>;
