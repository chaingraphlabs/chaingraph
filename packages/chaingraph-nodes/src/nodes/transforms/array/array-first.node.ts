...
@Node({
  type: 'ArrayFirstNode',
  title: 'Array First',
  description: 'Extract the first element from an array. Type: Array<T> → T',
  category: NODE_CATEGORIES.TRANSFORMS,
  tags: ['array', 'first', 'extract', 'head', 'transform'],
})
class ArrayFirstNode extends BaseNode {
  @Passthrough()
  @PortArray({
    title: 'Array',
    description: 'The array to extract the first element from',
    itemConfig: {
      type: 'any',
      title: 'Item',
    },
  ...
  @PortAny({
    title: 'Element',
    description: 'The first element from the array',
  })
  element: any = null
