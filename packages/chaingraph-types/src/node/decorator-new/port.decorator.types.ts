import type { IPortConfig as OriginalIPortConfig } from '@badaitech/chaingraph-types/port/base'
import type { ConfigTypeMap, ObjectSchema as IObjectSchema, PortType } from '@badaitech/chaingraph-types/port/base/types'
...
export type IPortConfigForDecorator = Omit<OriginalIPortConfig, 'type'> & {
