...
//  */
// export type PrimitiveValue<T extends PrimitivePortTypeUnion> = PrimitiveTypeMap[T]
//
// /**
//  * Helper for creating array port values
//  */
// export type ArrayOf<T extends PortType> = Arra<T>
//
// /**
...
//  * Common matrix types
//  */
// export type Matrix<T extends PrimitivePortTypeUnion> = NestedArrayValue<T, 2>
// export type Cube<T extends PrimitivePortTypeUnion> = NestedArrayValue<T, 3>
//
// // ----------------
...
//  */
// export function createPrimitiveConfig<T extends PrimitivePortTypeUnion>(
//   type: T,
//   id: string,
//   name: string,
