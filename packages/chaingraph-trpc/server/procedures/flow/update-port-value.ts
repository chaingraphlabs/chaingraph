...
import type { Flow, IPortConfig, ObjectPort } from '@badaitech/chaingraph-types'
...
export const addFieldObjectPort = flowContextProcedure
  ...
  .mutation(async ({ input, ctx }) => {
    ...
    try {
      ...
      const key = input.key
      const config: IPortConfig = {
        ...input.config,
        id: undefined, // id will be generated by the node
        connections: [], // connections will be managed by the node
      }
