...
export const baseUpdatePortValueFx = createEffect(async (params) => {
  return getStaticTRPCClient().flow.updatePortValue.mutate(params)
})

export const baseUpdatePortUIFx = createEffect(async (params) => {
  return getStaticTRPCClient().flow.updatePortUI.mutate(params)
})
...
export const addFieldObjectPortFx = createEffect(async (params: AddFieldObjectPortInput) => {
  return getStaticTRPCClient().flow.addFieldObjectPort.mutate(params)
})
...
export const removeFiledObjectPortFx = createEffect(async (params: RemoveFieldObjectPortInput) => {
  return getStaticTRPCClient().flow.removeFieldObjectPort.mutate(params)
})
...
export const appendElementArrayPortFx = createEffect(async (params: AppendElementArrayPortInput) => {
  return getStaticTRPCClient().flow.appendElementArrayPort.mutate(params)
})
...
export const removeElementArrayPortFx = createEffect(async (params: RemoveElementArrayPortInput) => {
  return getStaticTRPCClient().flow.removeElementArrayPort.mutate(params)
})
