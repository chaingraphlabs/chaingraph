...
const EventTitle = memo(({ event }: { event: ExecutionEventImpl }) => {
...
const EventDetails = memo(({ event, isVisible }: { event: ExecutionEventImpl, isVisible: boolean }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            'px-2.5 pb-2.5 pt-1 transition-all duration-200 overflow-hidden',
